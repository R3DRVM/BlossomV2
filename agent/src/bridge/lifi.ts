...
// ============================================
// Phase 4: Bridge Execution Functions
// ============================================
 ...
 */
export async function getLiFiRoute(params: LiFiQuoteParams & {
  fromAddress: string;
  toAddress?: string;
}): Promise<{
  ok: boolean;
  ...
  try {
    ...
    try {
      ...
      const transactionRequest: LiFiTransactionRequest = {
 ...
 */
export async function trackLiFiStatus(txHash: string, fromChainId: number): Promise<LiFiStatus> {
  try {
