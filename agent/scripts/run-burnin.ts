...
// Intent templates with sane amounts (100-500 USDC range)
const INTENT_TEMPLATES = [
  // Swaps - demo_dex (most reliable)
  { kind: 'swap', venue: 'demo_dex', text: 'swap 100 USDC for WETH' },
  { kind: 'swap', venue: 'demo_dex', text: 'swap 200 USDC to WETH' },
  { kind: 'swap', venue: 'demo_dex', text: 'buy 0.05 WETH with USDC' },
  { kind: 'swap', venue: 'demo_dex', text: 'swap 150 USDC for ETH' },

  // Deposits - demo_vault (reliable)
  { kind: 'deposit', venue: 'demo_vault', text: 'deposit 100 USDC to lending' },
  { kind: 'deposit', venue: 'demo_vault', text: 'deposit 200 USDC into vault' },
  { kind: 'deposit', venue: 'demo_vault', text: 'lend 150 USDC' },
  ...
  { kind: 'bridge', venue: 'bridge', text: 'bridge 100 USDC from ethereum to solana' },
];
