...
const TORTURE_INTENTS: TortureIntent[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  { category: 'normal', text: 'swap 100 USDC for WETH', description: 'Basic swap' },
  { category: 'normal', text: 'swap 200 USDC to ETH', description: 'Swap with native ETH' },
  { category: 'normal', text: 'deposit 150 USDC to lending', description: 'Basic deposit' },
  { category: 'normal', text: 'deposit 100 USDC into vault', description: 'Vault deposit' },
  ...
  { category: 'normal', text: 'buy 0.05 WETH with USDC', description: 'Buy specific amount' },
  { category: 'normal', text: 'lend 200 USDC', description: 'Simple lend' },
  ...
  { category: 'natural_language', text: 'SWAP 100 USDC FOR ETH!!!', description: 'All caps + punctuation' },
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  { category: 'plan_edit', text: 'swap 100 USDC for WETH', description: 'Base for edit: will modify amount' },
  { category: 'plan_edit', text: 'deposit 200 USDC to lending', description: 'Base for edit: will modify venue' },
  { category: 'plan_edit', text: 'long BTC with $150', description: 'Base for edit: will modify leverage' },
  { category: 'plan_edit', text: 'swap 50 USDC for ETH', description: 'Base for edit: small amount' },
  ...
  { category: 'extreme', text: 'swap 0.01 USDC for WETH', description: 'Dust amount' },
  { category: 'extreme', text: 'swap 999999999 USDC for ETH', description: 'Impossibly large amount' },
  { category: 'extreme', text: 'deposit 0.001 USDC to vault', description: 'Below minimum' },
  { category: 'extreme', text: 'long BTC 1000x $50', description: 'Unrealistic leverage' },
  { category: 'extreme', text: 'swap 1000000 ETH for USDC', description: 'More than total supply' },
  { category: 'extreme', text: 'deposit 0 USDC', description: 'Zero amount' },
  { category: 'extreme', text: 'swap -100 USDC for ETH', description: 'Negative amount', expectFail: true },

  // ─────────────────────────────────────────────────────────────────────────────
  // CATEGORY E: Unsupported Venues / Assets
  // ─────────────────────────────────────────────────────────────────────────────
  { category: 'unsupported', text: 'swap 100 USDC for DOGE on binance', description: 'CEX venue', expectFail: true },
  { category: 'unsupported', text: 'buy SHIB with 200 USDC', description: 'Unsupported token' },
  { category: 'unsupported', text: 'swap 100 USDC for PEPE', description: 'Meme token' },
  ...
  { category: 'unsupported', text: 'stake 100 USDC on lido', description: 'Wrong asset for Lido' },
  { category: 'unsupported', text: 'swap 100 USDC for BTC on uniswap', description: 'BTC on Uniswap' },

  // ─────────────────────────────────────────────────────────────────────────────
  // CATEGORY F: Cross-Chain Phrasing
  // ─────────────────────────────────────────────────────────────────────────────
  { category: 'cross_chain', text: 'bridge 100 USDC from ethereum to solana', chain: 'both', description: 'ETH->SOL bridge' },
  { category: 'cross_chain', text: 'send 200 USDC to solana', chain: 'both', description: 'Implicit bridge' },
  { category: 'cross_chain', text: 'move 150 USDC from eth to sol', chain: 'both', description: 'Short chain names' },
  { category: 'cross_chain', text: 'bridge 100 USDC solana to ethereum', chain: 'both', description: 'SOL->ETH bridge' },
  { category: 'cross_chain', text: 'swap 100 USDC on solana for ETH on ethereum', chain: 'both', description: 'Cross-chain swap' },
  { category: 'cross_chain', text: 'transfer 200 USDC cross-chain to solana', chain: 'both', description: 'Explicit cross-chain' },
  { category: 'cross_chain', text: 'bridge all my USDC to solana', chain: 'both', description: 'Bridge "all"' },

  // ─────────────────────────────────────────────────────────────────────────────
  // CATEGORY G: Rapid-Fire Sequences (will be batched)
  // ─────────────────────────────────────────────────────────────────────────────
  { category: 'rapid_fire', text: 'swap 10 USDC for WETH', description: 'Rapid #1' },
  { category: 'rapid_fire', text: 'swap 20 USDC for WETH', description: 'Rapid #2' },
  { category: 'rapid_fire', text: 'swap 30 USDC for WETH', description: 'Rapid #3' },
  { category: 'rapid_fire', text: 'swap 40 USDC for WETH', description: 'Rapid #4' },
  { category: 'rapid_fire', text: 'swap 50 USDC for WETH', description: 'Rapid #5' },
  { category: 'rapid_fire', text: 'deposit 10 USDC', description: 'Rapid deposit #1' },
  { category: 'rapid_fire', text: 'deposit 20 USDC', description: 'Rapid deposit #2' },
  { category: 'rapid_fire', text: 'deposit 30 USDC', description: 'Rapid deposit #3' },
  ...
  { category: 'failure_inject', text: 'swap USDC for', description: 'Incomplete intent', expectFail: true },
