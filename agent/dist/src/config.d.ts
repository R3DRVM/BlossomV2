...
export declare const USDC_ADDRESS_SEPOLIA: string | undefined;
export declare const WETH_ADDRESS_SEPOLIA: string | undefined;
export declare const DEMO_USDC_ADDRESS: string | undefined;
...
export declare const AAVE_USDC_ADDRESS: string | undefined;
