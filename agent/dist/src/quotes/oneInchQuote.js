 ...
 */
import { ONEINCH_API_KEY, ONEINCH_BASE_URL, ETH_TESTNET_CHAIN_ID, } from '../config';
/**
 * Fetch a quote from 1inch API (read-only, no execution data)
 * @param request Quote request parameters
 * @returns Quote result or undefined if quote fails
 */
export async function getOneInchQuote(request) {
 ...
 */
export function isOneInchAvailable() {
 ...
 */
export function getOneInchChainId() {
