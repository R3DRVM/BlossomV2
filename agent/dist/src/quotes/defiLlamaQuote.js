...
const FALLBACK_VAULTS = [
    { name: 'Aave USDC', apy: 5.0, tvl: 1000000, poolId: 'demo-aave-usdc', protocol: 'Aave' },
    { name: 'Compound USDC', apy: 4.5, tvl: 800000, poolId: 'demo-compound-usdc', protocol: 'Compound' },
...
let cachedProtocolsTVL = null;
let protocolsCacheTimestamp = 0;
