...
exports.REDACTED_ADDRESS_SEPOLIA = process.env.REDACTED_ADDRESS_SEPOLIA;
exports.WETH_ADDRESS_SEPOLIA = process.env.WETH_ADDRESS_SEPOLIA;
// Demo swap venue (deterministic for investor demos)
exports.DEMO_REDACTED_ADDRESS = process.env.DEMO_REDACTED_ADDRESS;
...
exports.AAVE_REDACTED_ADDRESS = process.env.AAVE_REDACTED_ADDRESS || exports.DEMO_REDACTED_ADDRESS; // Use demo REDACTED if not set
