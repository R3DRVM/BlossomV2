...
Example JSON output:
{
  ...
  "actions": [
    ...
    const isDefiIntent = /park|deposit|earn yield|lend|supply|yield/i.test(userMessage) &&
        (lowerMessage.includes('usdc') || lowerMessage.includes('stablecoin') || lowerMessage.includes('yield'));
