...
```json
{
  ...
  "data": {
    ...
    "amountExecuted": {
      "byToken": [{ "token": "USDC", "totalUnits": "1000000.000000" }],
      "unpricedCount": 10
    },
    "feesCollected": {
      "byToken": [{ "token": "USDC", "totalFeeUnits": "2500.000000", "last24hFeeUnits": "500.000000" }],
      "feeBps": 25,
      "unpricedCount": 5
    },
...
# With token/amount
npm run devnet:exec-batch -- --n=25 --concurrency=5 --token=USDC --amount=1000000
```
