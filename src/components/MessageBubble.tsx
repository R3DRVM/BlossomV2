                        ...
                        <div className="flex gap-2 pt-1">
                          <button
                            onClick={() => {
                              ...
                              const messageText = `Allocate amountPct:"10" to protocol:"${protocolName}" USDC yield`;
                          ...
                          <button
                            onClick={() => {
                              ...
                              const messageText = `Allocate amountUsd:"500" to protocol:"${protocolName}" USDC yield`;
        ...
        {!isUser && defiProposal && (
          <div className="mt-1.5 w-full max-w-md bg-white rounded-2xl shadow-sm border border-blossom-outline strategy-card">
            ...
            <div className="text-[11px] text-blossom-slate mb-2 pt-1.5 border-t border-blossom-outline/50">
              <div className="mb-1">Choosing the highest APY within your risk band using idle USDC.</div>
