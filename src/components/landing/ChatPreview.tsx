...
const SCENARIOS: ChatScenario[] = [
  ...
  },
  {
    id: 'defi',
    label: 'DeFi',
    user: 'Park half my idle USDC into the safest yield on Kamino.',
    blossom: [
      'Scanning Kamino USDC strategies for risk-adjusted yield…',
      'Selected conservative vault with high TVL and low volatility.',
      'Allocating 50% of idle USDC and tracking yield in your portfolio.',
    ],
  },
  {
    id: 'prediction',
