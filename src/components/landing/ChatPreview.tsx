...
const SCENARIOS: ChatScenario[] = [
  ...
  },
  {
    ...
    messages: [
      {
        role: 'user',
        text: 'Park half my idle REDACTED into the safest yield on Kamino.',
      },
      {
        role: 'blossom',
        text: 'Scanning Kamino REDACTED vaults for risk-adjusted yield… Selected a conservative, high-TVL vault and allocating 50% of idle REDACTED. I'll track APY and risk for you.',
      },
    ],
  },
  {
