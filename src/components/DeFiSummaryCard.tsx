        ...
        <div className="space-y-2 pt-4 border-t border-blossom-outline/50">
          {!isEditingDeposit ? (
            ...
            <div className="space-y-3">
              <div>
                <label className="block text-xs font-medium text-blossom-ink mb-1">New deposit amount (USDC)</label>
                <input
                  type="number"
              ...
              <div className="flex gap-2">
                <button
                  onClick={() => {
                    ...
                    // Check if we have enough USDC for increase
                    if (depositDelta > 0 && usdcBalance < depositDelta) {
                      setEditError(`Insufficient USDC. Available: $${usdcBalance.toLocaleString()}, needed: $${depositDelta.toLocaleString()}`);
                      return;
                    }
