...
export default function DeFiView() {
  ...
  const handleGeneratePlan = () => {
    const command = commandInput.trim() || 'Deploy idle USDC into safest yield with max 5% drawdown.';
    createDefiPlanFromCommand(command);
    setCommandInput('');
  };

  const activePositions = defiPositions.filter(p => p.status === 'active');
  const idleUsdc = account.balances.find(b => b.symbol === 'USDC')?.balanceUsd || 0;
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 shadow-sm">
          ...
          <div className="flex gap-2">
            <textarea
              ...
              placeholder="Deploy idle USDC into safest yield with max 5% drawdown."
          ...
          <div className="mt-2 text-xs text-gray-500">
            Idle USDC: ${idleUsdc.toLocaleString()}
          </div>
        </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4 shadow-sm">
            ...
            <div className="mt-4 pt-4 border-t border-gray-100">
              ...
              <ul className="space-y-1 text-xs text-gray-600 list-disc pl-5">
                ...
                <li>Keeps at least 50% of USDC in cash.</li>
