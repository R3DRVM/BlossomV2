...
2. `USDC_ADDRESS_SEPOLIA` or `WETH_ADDRESS_SEPOLIA` not set
...
3. `USDC_ADDRESS_SEPOLIA` or `WETH_ADDRESS_SEPOLIA` not set
...
1. **Portfolio Sync:** ✅ Already implemented
   ...
   - Merges real balances (USDC, WETH, ETH) with simulated (DEFI)
