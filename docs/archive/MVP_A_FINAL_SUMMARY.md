...
- Fetches real ETH, WETH, USDC balances from Sepolia
...
- [ ] Wallet card shows real USDC balance (if > 0)
...
### What Works
- ✅ Real wallet balance fetching (ETH, WETH, USDC)
