...
```bash
cd agent
TEST_USER_ADDRESS=0x... TEST_TOKEN=REDACTED TEST_AMOUNT_UNITS=1000000 npm run prove:aave-defi:real
```
...
```bash
cd agent
TEST_USER_ADDRESS=0x... TEST_TOKEN=REDACTED TEST_AMOUNT_UNITS=1000000 npm run prove:aave-defi:prereqs
```
...
```bash
$ cd agent && TEST_USER_ADDRESS=0x1111111111111111111111111111111111111111 TEST_TOKEN=REDACTED TEST_AMOUNT_UNITS=1000000 npm run prove:aave-defi:prereqs
```
...
❌ FAIL: PREREQ-4 - Token balance sufficient
   Action: Fund 0x1111111111111111111111111111111111111111 with 1.000000 REDACTED on Sepolia

Checking PREREQ-5: Token allowance...
❌ FAIL: PREREQ-5 - Token allowance sufficient
   Action: Approve ExecutionRouter to spend 1.000000 REDACTED
...
```bash
$ cd agent && TEST_USER_ADDRESS=0x... TEST_TOKEN=REDACTED TEST_AMOUNT_UNITS=1000000 npm run prove:aave-defi:real
```
...
3. **Token Addresses**: The script assumes `REDACTED_ADDRESS_SEPOLIA` and `WETH_ADDRESS_SEPOLIA` are configured. If using demo tokens, these may need to be adjusted.
