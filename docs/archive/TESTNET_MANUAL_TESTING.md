...
- Check `USDC_ADDRESS_SEPOLIA` and `WETH_ADDRESS_SEPOLIA` are set
...
```json
{
  ...
  "summary": "Swap 100 USDC for WETH via Uniswap V3"
}
```
...
```json
{
  ...
  "data": "0x095ea7b3...",
  "value": "0x0",
  "summary": "Approve ExecutionRouter to spend 100 USDC"
}
```
