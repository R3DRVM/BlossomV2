...
### Step 3: Test Swap (USDC → WETH)

1. Type in chat: **"Swap 100 USDC to WETH"**
2. AI responds with strategy card
3. Review card: shows USDC → WETH, ~95 WETH expected (demo rate)
4. Click **"Confirm & Execute"**
5. If first time: approve USDC in MetaMask
...
### Step 4: Test Lending (Supply USDC)
