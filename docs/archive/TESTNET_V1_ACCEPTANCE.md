...
2. **Yield Parking** - Supply idle REDACTED to lending
...
### Flow B: Park Idle REDACTED into Yield

**User Action:**
> "Put 250 REDACTED into lending"
...
**Expected Network Interaction (eth_testnet mode):**
- Approval for DEMO_REDACTED to ExecutionRouter (one-time)
...
**User Action:**
> "Buy 50 REDACTED on YES for Fed rate cut"
...
- [ ] Demo tokens funded (DEMO_REDACTED balance > 0)
...
| DEMO_REDACTED | `DEMO_REDACTED_ADDRESS` | Demo token |
...
2. Say "Swap 100 REDACTED to WETH"
3. Confirm strategy
...
1. Connect wallet (Sepolia)
2. Say "Supply 100 REDACTED to lending"
3. Confirm strategy
...
1. Connect wallet (Sepolia)
2. Say "Buy YES on fed rate cut, 50 REDACTED"
3. Confirm strategy
4. Verify: proof tx executed
