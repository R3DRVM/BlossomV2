...
5. Demo tokens minted (10k REDACTED, 5 WETH)
...
**Say:** *"Let's put some idle REDACTED to work."*
...
- ✅ REDACTED balance decreases, shares received
...
- 1 DeFi position (100 REDACTED @ 5% APR)
