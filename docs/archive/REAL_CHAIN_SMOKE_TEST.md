...
USDC_ADDRESS_SEPOLIA=0x...  # Sepolia USDC (if available)
...
- Wallet USDC balance: `0 USDC` (or minimal)

**Expected:**
- User has ETH but no WETH/USDC (for Route 2 test)
...
| Step | ETH Delta | WETH Delta | USDC Delta | Gas Paid By |
|------|-----------|------------|------------|-------------|
| **Initial** | `X ETH` | `0 WETH` | `0 USDC` | - |
| **Create Session** | `-0.0001 ETH` | `0 WETH` | `0 USDC` | User |
| **Swap (Relayed)** | `-0.01 ETH` | `+0.01 WETH` | `0 USDC` | Relayer |
| **Final** | `X - 0.0101 ETH` | `0.01 WETH` | `0 USDC` | - |
