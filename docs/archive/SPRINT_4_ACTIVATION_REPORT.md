...
**Action Required**:
1. Fund a test wallet with Sepolia USDC (at least 1 USDC = 1000000 units)
2. Set env vars:
   ```bash
   export TEST_USER_ADDRESS=0x...
   export TEST_TOKEN=USDC
...
1. Get Sepolia USDC from faucet (at least 1 USDC = 1000000 units)
