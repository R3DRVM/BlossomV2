...
6. Connect wallet
7. **Expected:** Wallet card shows real balances (ETH/WETH/REDACTED) from Sepolia
...
2. Start frontend
3. **Expected:** Wallet card shows mock balances ($10,000 account value, REDACTED/ETH/SOL)
...
- **Balances:** Real ETH/WETH/REDACTED from Sepolia
