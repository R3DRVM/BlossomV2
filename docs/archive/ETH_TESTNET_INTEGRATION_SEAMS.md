...
- `account.balances`: `AssetBalance[]` - Current balances (USDC, ETH, SOL, etc.)
...
**Available Fields**:
- `protocol`: String (e.g., "Aave", "Lido", "Morpho")
- `asset`: String (e.g., "USDC") - **single asset only, no swap pairs**
