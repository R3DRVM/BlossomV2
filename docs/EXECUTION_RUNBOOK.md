...
# Common fixes:
# 1. Verify REDACTED_ADDRESS_SEPOLIA and WETH_ADDRESS_SEPOLIA are set
...
- REDACTED decreases, WETH increases (for swap)
...
**Portfolio fails:**
- Check: `REDACTED_ADDRESS_SEPOLIA` and `WETH_ADDRESS_SEPOLIA` set?
