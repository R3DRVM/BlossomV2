...
if [ "$SKIP_DEPLOY" = "1" ]; then
    ...
    : "${USDC_ADDRESS_SEPOLIA:?ERROR: USDC_ADDRESS_SEPOLIA required when SKIP_DEPLOY=1}"
    ...
    USDC_SEPOLIA="$USDC_ADDRESS_SEPOLIA"
...
if [ "$SKIP_DEPLOY" = "1" ]; then
    ...
    echo "  USDC_ADDRESS_SEPOLIA: $USDC_SEPOLIA"
...
export USDC_ADDRESS_SEPOLIA="$USDC_SEPOLIA"
