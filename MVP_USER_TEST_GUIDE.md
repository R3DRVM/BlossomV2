...
3. **Demo Tokens** (DEMO_REDACTED, DEMO_WETH) - Auto-minted when you first interact
...
- ✅ Balance displays: ETH, DEMO_REDACTED, DEMO_WETH
...
2. Shows:
   ...
   - Est. APR: 5% (demo)
3. Click **"Execute Strategy"**
4. Approve REDACTED spending (if first time)
...
#### Prompt:
```
Swap 50 REDACTED to WETH
```

#### What Should Happen:
1. AI creates swap plan
2. Shows:
   - From: 50 DEMO_REDACTED
   - To: ~X DEMO_WETH
...
#### Verify:
- [ ] DEMO_REDACTED balance decreased
