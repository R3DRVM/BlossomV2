...
| `demo/DemoERC20.sol` | Mintable ERC20 for demo tokens (DEMO_REDACTED, DEMO_WETH) |
...
- Max 1 ETH per swap
- Only allowed tokens (ETH/WETH/REDACTED)
...
- **Rate**: Fixed 95% (5% fee)
- **Decimals**: Handles 6 (REDACTED) ↔ 18 (WETH) conversions
- **Liquidity**: Pre-seeded at deployment (1M REDACTED, 1000 WETH)
...
```
User: "Supply 250 REDACTED to lending"
         │
         ▼
┌─────────────────────────────────────────────────────────────────┐
...
Action 0: PULL (actionType: 2) - transfer REDACTED from user to router  
...
| Demo token swaps | ✅ Real | DEMO_REDACTED ↔ DEMO_WETH on Sepolia |
| Demo lending supply | ✅ Real | DEMO_REDACTED → DemoLendVault on Sepolia |
