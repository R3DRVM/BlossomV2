...
- Real wallet balance fetching (ETH, WETH, REDACTED from Sepolia)
...
2. **Wallet Card:** Shows real ETH, WETH, REDACTED balances
...
1. **DeFi Deposit:** "Deposit 1000 REDACTED into Kamino"
...
2. **Swap:**
   - Send: "Swap 10 REDACTED to WETH"
   - Expected: ExecutionResult with `simulatedTxId`, portfolio updated

3. **DeFi Deposit:**
   - Send: "Deposit 1000 REDACTED into Kamino"
...
1. ✅ Real wallet balance fetching (ETH, WETH, REDACTED from Sepolia)
